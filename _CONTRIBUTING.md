...
1. Fork the central repo at [https://github.com/PeacefulSplinter/thesis](https://github.com/PeacefulSplinter/thesis)
...
1. Configure the remotes by adding the central repository as 'upstream'
    ...
    ```bash
    $ git remote add upstream https://github.com/PeacefulSplinter/thesis.git
    ```
